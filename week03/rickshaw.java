...
{public static void main(String[] args) {
        ...
        // Base configuration
        double baseFare = 20;              // Flat charge
        double perKm = 10;                 // Rate per kilometer
        double perMinute = 2;              // Rate per minute
        double longDistanceDiscount = 0.10; // 10% discount for locals if distance > 15 km
        ...
        System.out.print("Is the traveling customer local? (yes/no): ");
        String isLocalInput = sc.next().trim().toLowerCase();

        System.out.print("Is the travel during nighttime? (yes/no): ");
